...
from assistant.capabilities.browser.actions import (
    click_by_role,
    click_text,
    fill_label,
    fill_placeholder,
...
from assistant.capabilities.browser.context import (
    get_browser_state,
    get_page_context,
)

from assistant.capabilities.browser.research import (
    read_current_source,
    search_web,
)

from assistant.capabilities.browser.session import (
    activate_tab,
    close_browser,
    close_tab,
    go_back,
