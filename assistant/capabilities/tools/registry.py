...
Important:
    ...
    assistant.capabilities.tools.registry module.
...
def load_default_tools():
    ...
    When this module is imported normally as assistant.capabilities.tools.registry,
...
if __name__ == "__main__":
    ...
    python -m assistant.capabilities.tools.registry executes this source file under
    the name __main__.

    Tool modules import assistant.capabilities.tools.registry by its canonical
